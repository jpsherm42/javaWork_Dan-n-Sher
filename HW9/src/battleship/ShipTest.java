...
class ShipTest {
	...
	void testallShipCoordinates() {
		...
		//test when horizontal
		Battleship battleship = new Battleship();
		int row = 7;
		int column = 4;
		boolean horizontal = true;
		
		int[][] coordinates = battleship.allShipCoordinates(row, column, horizontal);
		int[][] correctValues = {{7,4}, {7,3}, {7,2}, {7,1}};
		assertArrayEquals(coordinates, correctValues);
