...
CREATE TABLE `holds` (
  ...
  CONSTRAINT `holds_ibfk_1` FOREIGN KEY (`book_ID`) REFERENCES `books` (`book_ID`),
  CONSTRAINT `holds_ibfk_2` FOREIGN KEY (`patron_ID`) REFERENCES `patrons` (`patron_ID`)
...
INSERT INTO `holds` VALUES (10,13,10,'2020-11-03'),(11,13,12,'2020-12-01'),(12,15,14,'2020-11-15');
