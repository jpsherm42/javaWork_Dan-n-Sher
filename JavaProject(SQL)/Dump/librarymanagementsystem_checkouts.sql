...
CREATE TABLE `checkouts` (
  ...
  CONSTRAINT `checkouts_ibfk_2` FOREIGN KEY (`patron_ID`) REFERENCES `patrons` (`patron_ID`)
...
INSERT INTO `checkouts` VALUES (10,10,11,'2020-08-01'),(11,11,13,'2020-12-01'),(12,13,11,'2020-11-30'),(13,15,10,'2020-12-05');
